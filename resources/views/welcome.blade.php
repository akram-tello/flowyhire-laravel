      ...
      <div class="col-12">
        <nav class="navbar navbar-expand-lg blur border-radius-xl top-0 z-index-fixed shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
          <div class="container-fluid">
            ...
            <a href={{url('/')}}><img src="../assets/img/615c1d123404b3d35c6fb81e_flowyhire.png" width="182" height="42" alt="FlowyHire Logo" class="navbar-brand font-weight-bolder ms-sm-3"></a>
            ...
            <div class="collapse navbar-collapse pt-3 pb-2 py-lg-0">
              ...
              <ul class="navbar-nav navbar-nav-hover ms-auto">
                ...
                <li class="nav-item ms-lg-auto my-auto ms-3 ms-lg-0">
                  <a target="_blank" href="https://calendly.com/flowyteam/flowyhire?month=2022-04" class="btn btn-sm bg-gradient-primary mb-0 me-1 mt-2 mt-md-0" style="background:#F4454F">Schedule a Demo</a>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row justify-content-center text-sans-serif">
          <div class="col-lg-8 text-center mx-auto my-auto">
            ...
            <a target="_blank" href="https://calendly.com/flowyteam/flowyhire?month=2022-04" type="submit" class="btn bg-gradient-primary btn-lg" style="background:#F4454F">Schedule a Demo</a>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6 m-auto">
              ...
              <p class="mb-4 lead">
                ...
                Instead, pay your team members each month with 1 bulk payment, and FlowyHire will make sure they get paid on time,
        ...
        <div class="container text-sans-serif">
          <div class="row">
            <div class="col-md-6 m-auto">
              ...
              <p class="mb-4 lead">
                Your team members deserve the best, wherever they live. With FlowyHire you can
    ...
    <div class="container">
      <div class=" row">
        <div class="col-md-3 mb-4 ms-auto">
          <div>
            {{-- <a href="#">
              <img src="https://uploads-ssl.webflow.com/615c1a090c4d2f60e01faad3/615c1d123404b3d35c6fb81e_flowyhire.png" class="mb-3 footer-logo" alt="main_logo">
            </a> --}}
            <h6 class="font-weight-bolder mb-4">FlowyHire</h6>
          </div>
          <div>
        ...
        <div class="col-12">
          <div class="text-center">
            <p class="text-dark my-4 text-sm font-weight-normal">
              ...
              </script><a href="#" target="_blank">FlowyHire</a>.
            </p>
          </div>
        </div>
      </div>
